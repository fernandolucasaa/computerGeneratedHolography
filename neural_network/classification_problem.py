...
def load_data(opt):
    ...
    if opt == 1: # Hologram dataset
        ...
        x_train = np.load('classification_problem/hologram/X_train.npy')
        y_train = np.load('classification_problem/hologram/Y_train.npy')
        x_test = np.load('classification_problem/hologram/X_test.npy')
        y_test = np.load('classification_problem/hologram/Y_test.npy')

    elif opt == 2: # Wigner distribution dataset

        x_train = np.load('classification_problem/wigner_distribution/X_train.npy')
        y_train = np.load('classification_problem/wigner_distribution/Y_train.npy')
        x_test = np.load('classification_problem/wigner_distribution/X_test.npy')
        y_test = np.load('classification_problem/wigner_distribution/Y_test.npy')
...
def plot_history(history, opt):
    ...
    if opt == 1: # Hologram dataset
        plt.savefig('classification_problem/hologram/history.png')
    elif opt == 2: # Wigner distribution dataset
        plt.savefig('classification_problem/wigner_distribution/history.png')
...
def save_model(model, opt):
    ...
    # Files
    if opt == 1: # Hologram dataset
        file_model = 'classification_problem/hologram/model.json'
        file_weights = 'classification_problem/hologram/model.h5'
    elif opt == 2: # Wigner distribution datset
        file_model = 'classification_problem/wigner_distribution/model.json'
        file_weights = 'classification_problem/wigner_distribution/model.h5'
...
def callback_functions(opt):
    ...
    if opt == 1: # Hologram dataset
        path_logs = os.getcwd() + '/classification_problem/hologram/logs'
    elif opt == 2:
        path_logs = os.getcwd() + '/classification_problem/wigner_distribution/logs'
...
def main():
    ...
    # Choose an option
    option2 = int(input('Do you want to train the neural network (MLP) [1] or ' \
